            ...
            <div class="cs-container">
                <div class="cs-content">
                    <div class="cs-flex">
                        ...
                        <h2 id="why_choose" class="cs-title">Почему Вы можете доверять нам?</h2>
                    </div>
                    <p id="why_desc" class="cs-text">
                ...
                <ul class="cs-card-group">
                    <li class="cs-item">
                        ...
                        <h3 id="why_1" class="cs-h3">Качество услуг</h3>
                        <p id="why_1_text" class="cs-item-text">
                    ...
                    <li class="cs-item">
                        ...
                        <h3 id="why_2" class="cs-h3">Опытные сотрудники</h3>
                        <p id="why_2_text" class="cs-item-text">
                    ...
                    <li class="cs-item">
                        ...
                        <h3 id="why_3" class="cs-h3">Полная прозрачность</h3>
                        <p id="why_3_text" class="cs-item-text">
