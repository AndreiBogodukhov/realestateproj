...
const translations = {
    'RU': {
        ...
        'au_statistics': 'Статистика',
        'au_au': 'Немного о нас',
        'au_first_text': 'Мы молодая компания в мире недвижимости, но наш индивидуальный подход делает нас уникальными. Наша целеустремленная команда стремится к тому, чтобы каждый клиент получил именно то, что ему нужно, с особенным вниманием к деталям и предпочтениям.',
        'au_h3_1': 'Сберегающие стратегии',
        'au_h3_2': 'Планирование налогов',
        'au_h3_3': 'Доверие компании',
        'au_thebest': 'В мире однотипных предложений мы выделяемся как молодая компания с индивидуальным подходом. Наше стремление к инновациям и гибкость в работе позволяют нам точно понимать потребности каждого клиента и предлагать персонализированные решения.',
        'au_thebest_head': 'Лучшие в своей нише',
        'au_number_1': 'Позитивные отклики',
        'au_number_2': 'Средняя ставка',
        'au_number_3': 'Онлайн поддержка',
        'au_mission': 'Наша миссия и видение',
        'au_individ': 'Индивидуальный подход',
        'au_individ_text': 'Наша команда стремится помогать людям не просто находить дом, но и настоящее убежище, где их сердца наполняются счастьем. Мы уделяем особое внимание каждому клиенту, стремясь не только к профессионализму, но и к глубокому чувству заботы. Наш подход к работе не ограничивается количеством сделок, мы стремимся к высокому качеству в каждой из них.',
        'au_diff': 'Наша особенность',
        'au_text_4': 'Каждый дом, предлагаемый нашей компанией, проходит тщательный отбор, чтобы соответствовать не только красоте, но и образу жизни каждого клиента. Мы гордимся разнообразием предлагаемых вариантов – от уютных квартир в центре города до роскошных вилл на природе. Понимая, что дом – это не просто строение, мы стремимся создать для наших клиентов незабываемые моменты и воспоминания.',
    },
    'EN': {
        'language_cap': 'EN',
        ...
        'au_statistics': 'Statistics',
        'au_au': 'About Us',
        'au_first_text': 'We are a young company in the real estate world, but our individual approach makes us unique. Our dedicated team strives to ensure that each client gets exactly what they need, with special attention to details and preferences.',
        'au_h3_1': 'Savings Strategies',
        'au_h3_2': 'Tax Planning',
        'au_h3_3': 'Trusted Company',
        'au_thebest': 'In a world of uniform offerings, we stand out as a young company with an individual approach. Our commitment to innovation and flexibility in work enable us to accurately understand the needs of each client and offer personalized solutions.',
        'au_thebest_head': 'Customer care',
        'au_number_1': 'Positive reviews',
        'au_number_2': 'Average interest rate',
        'au_number_3': 'Online support',
        'au_mission': 'Our mission and vision',
        'au_individ': 'Individual approach',
        'au_individ_text': 'Our team aims to help people find not just a house, but a true sanctuary where their hearts are filled with happiness. We pay special attention to each client, striving for not only professionalism but also a profound sense of care. Our approach to work is not limited to the number of transactions; we strive for high quality in each one.',
        'au_diff': 'Our distinctive feature',
        'au_text_4': 'Every home offered by our company undergoes careful selection to match not only beauty, but also the lifestyle of each client. We take pride in the variety of options we offer - from cozy apartments in the city center to luxurious villas in natural surroundings. Understanding that a home is not just a building, we aim to create unforgettable moments and memories for our clients.',
        'au_text_5': 'Our pride lies in our clients, who become not just buyers, but members of our large family. We not only successfully close deals, but also maintain warm and friendly relationships. We are confident that your success is our success, and we are always ready to move forward together with you.'
